        ...
        <div class="row">
          <div class="col-xs-6">
            <div class="page-title">
              <h2 id="PageTitle" style="color:black;">Order Complete</h2>
            </div>
          </div>
          <!--<div class="col-xs-6">
              ...
              <div class="thanksContent">
                ...
                <h2 style="position:relative">
                  <p style="background:#47BAC1; padding:20px 50px; color:white; display:inline-block">
                    ...
                    <br/>
                    <br/>
                    <span style="font-size:30px" id="orderid">-</span>
                  </p>
                  
                </h2>
                <a data-toggle="modal" href="?code=maprodfron" class="btn btn-primary" style="background:#dedede; color:black; border:none; padding:15px 30px; border-radius:0">
                  <span> Continue Shopping </span>
                </a>
                <a data-toggle="modal" href="?code=TAPCS3" class="btn btn-primary" style="background:#dedede; color:black;  border:none; padding:15px 30px; border-radius:0; position:absolute; right:50px">
