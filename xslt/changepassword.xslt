				...
				<div class="row">
					<div class="col-xs-6">
						<div class="page-title">
							<h2 id="PageTitle" style="color:black;">CHANGE PASSWORD</h2>
						</div>
					</div>
					<!--<div class="col-xs-6">
					...
					<div class="col-md-6 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form action="" method="POST" role="form" id="changepwd">
									<p class="help-block">Please enter a new Password </p>
									<div class="form-group">
										<label for="">Password</label>
										<input type="password" class="form-control" id="CAUPWDpassword" name="Nmpassword"/>
									</div>
									<div class="form-group">
