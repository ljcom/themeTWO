...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="sqroot/body/bodyContent/browse/content/row">
   <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700"  data-title="Slide 3" class="homeslider" style="display:none;">
      <img src="{fields/field[@caption = 'Attachment']/.}" onerror="this.src='ophcontent/themes/themeTWO/images/white.jpg'" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" />
      ...
      <div class="slide">
        <div class="productImage" style="background:#F1E39A">
          <div style="width:100px; height:100px;">
            <img src="{pageURL/.}" onerror="this.src='ophcontent/themes/themeTWO/images/white.jpg'" />
          </div>
        </div>
