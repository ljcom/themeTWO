								...
								<ul class="nav nav-tabs" id="cart-tabs"  style="border-bottom:0;">
									<div class="row progress-wizard" style="border-bottom:0; padding-bottom:20px;">
										<div class="col-xs-6 progress-wizard-step disabled">
											...
											<a href="#f1default" data-toggle="tab" class="progress-wizard-dot">|</a>
										</div>
										<div class="col-xs-6 progress-wizard-step disabled">
											...
											<div class="col-xs-12">
												<div class="well well-lg clearfix">
													<ul class="pager">
														...
														<li class="next">
															<a href="#tab4default"  data-toggle="tab">Continue</a>
														</li>
													</ul>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<address>
														...
														<br />
														<span id="PCSO_CustomerAddress_browse"><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage/formSections/formSection/formCols/formCol/formRows/formRow/fields/field[@fieldName='CustomerAddress']/textBox/value/." /></span>
														<br />
														<span id="PCSO_City_browse"><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage/formSections/formSection/formCols/formCol/formRows/formRow/fields/field[@fieldName='City']/textBox/value/." /></span>
														<br/>
														<span id="PCSO_Country_browse"><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage/formSections/formSection/formCols/formCol/formRows/formRow/fields/field[@fieldName='Country']/textBox/value/." /></span>
													</address>
													<script>
													...
													<div class="row">
														<div class="col-sm-4 col-xs-12">
															<address>
																<a href="#">
																	Email:
																	<span id="PCSO_personalEmail_browse"><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage/formSections/formSection/formCols/formCol/formRows/formRow/fields/field[@fieldName='PersonalEmail']/textBox/value/." /></span>
																</a> <br />
																Phone : +<span id="PCSO_Phone_browse"><xsl:value-of select="sqroot/body/bodyContent/form/formPages/formPage/formSections/formSection/formCols/formCol/formRows/formRow/fields/field[@fieldName='Phone']/textBox/value/." /></span>
															</address>
														</div>
